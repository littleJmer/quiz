...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@littlejmer/quiz";
  public static final String SHELL_APP_SCHEME = "expda847d26fee54271ada6ce92fcaafed9";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@littlejmer/quiz", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40littlejmer%2Fquiz%2F1.0.0%2Fd6b10bfce4b0199adfe9ad6a00be5b65-34.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
